...
String username = jTextField1.getText().trim();
    ...
    try {
        // Koneksi ke database
        Connection conn = java.sql.DriverManager.getConnection("jdbc:mysql://localhost:3306/laundry", "root", "");
        ...
        if (rs.next()) {
            ...
            // Simpan user baru dengan akses 'pegawai'
            String sql = "INSERT INTO users (username, password, akses) VALUES (?, ?, 'pegawai')";
